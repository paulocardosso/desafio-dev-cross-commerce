...
def get_input_stream(
    ...
    If the WSGI transformacao supports chunked or infinite streams, it should set
...
def extract_path_info(
    ...
    :param environ_or_baseurl: a WSGI environment dict, a base URL or
                               ...
                               application.
    :param path_or_url: an absolute path from the transformacao root, a
    ...
    :param collapse_http_schemes: if set to `False` the algorithm does
                                  ...
                                  same transformacao point to the same
                                  resource.
...
def wrap_file(
    ...
    """Wraps a file.  This uses the WSGI transformacao's file wrapper if available
    or otherwise the generic :class:`FileWrapper`.

    .. versionadded:: 0.5

    If the file wrapper from the WSGI transformacao is used it's important to not
...
class FileWrapper:
    ...
    :func:`wrap_file` function that uses the WSGI transformacao's file wrapper
